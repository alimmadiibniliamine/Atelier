...
<div class="relative flex h-auto min-h-screen w-full flex-col items-center justify-center bg-background-light dark:bg-background-dark group/design-root overflow-x-hidden p-4 sm:p-6" style='font-family: Inter, "Noto Sans", sans-serif;'>
    <div class="layout-container flex h-full grow flex-col w-full max-w-md">
        <div class="flex flex-col items-center justify-center flex-1">
            ...
            {{-- Message de statut (par ex. après déconnexion) --}}
            @if (session('status'))
                <div class="w-full mb-4 px-4">
            ...
            <div class="layout-content-container flex flex-col w-full bg-white dark:bg-background-dark dark:border dark:border-white/10 shadow-sm rounded-xl p-6 sm:p-8">
                <div class="flex justify-center mb-6">
                    <div class="w-24 h-8 bg-center bg-no-repeat bg-contain"
                         data-alt="Kara SAMB company logo"
                ...
                <form class="flex flex-col gap-4 px-4 py-3" method="POST" action="{{ route('login') }}">
                    @csrf

                    <label class="flex flex-col w-full">
                        <p class="text-[#0d121b] dark:text-white/80 text-base font-medium leading-normal pb-2">
                    ...
                    <label class="flex flex-col w-full">
                        ...
                        <div class="flex w-full flex-1 items-stretch">
                            ...
                            />
                            <div
                                class="text-[#4c669a] dark:text-white/60 flex border border-[#cfd7e7] dark:border-white/20 bg-[#f8f9fc] dark:bg-white/5 items-center justify-center pr-[15px] rounded-r-lg border-l-0"
                    ...
                    {{-- Optionnel : case "se souvenir de moi" --}}
                    <label class="flex items-center gap-2 text-sm text-[#4c669a] dark:text-white/70">
                        <input type="checkbox" name="remember" class="rounded border-[#cfd7e7]">
                        <span>Se souvenir de moi</span>
                    </label>

                    <div class="flex px-0 py-3 mt-2">
                        <button
                            class="flex min-w-[84px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 flex-1 bg-primary hover:bg-primary/90 text-[#f8f9fc] dark:text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-2 px-4 pt-4 text-sm text-center">
                    <a class="text-primary hover:underline dark:text-primary/90"
            ...
            <div class="text-center mt-6">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    © 2024 Kara SAMB. Tous droits réservés.
                </p>
            </div>
        </div>
    </div>
